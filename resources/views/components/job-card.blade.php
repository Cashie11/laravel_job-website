...
<div class="rounded-lg shadow-md bg-white p-4">
    <div class="flex items-center space-between gap-4">
        @if($job->company_logo)
        <img src="{{asset('storage/' . $job->company_logo)}}" alt="{{$job->company_name}}" class="w-14 h-14 object-contain" />
        @else
        <img src="{{asset('storage/logos/logo-shield.png')}}" alt="Default Company Logo" class="w-14 h-14 object-contain" />
        @endif
        <div>
